...
//       // Parse subject-related fields
//       const tinChiLyThuyet = sanitizedRow["TC lý thuyết"]; // Ensure no undefined value
//       const tinChiThucHanh = sanitizedRow["TC thực hành"]; // Ensure no undefined value
...
//         : 0;
//       const loaiMonHoc = sanitizedRow["Loại MH"] || "Unknown";

//       // Check if course exists, otherwise create it
//       let existCourse = await Course.findOne({
//         ma_lop_hoc_phan: sanitizedRow["Mã lớp học phần"],
//       });
...
//           await existCourse.save(); // Uncomment this to save course after updating
//         }
//       }
...
//         }
//       }
//       await semester.save(); // Uncomment this to save semester
//     }
